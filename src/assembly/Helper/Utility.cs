...
namespace PoshBox.Helper
{
    ...
    public static class FolderUtility
    {
        ...
        /// <param name="recursionDepth">(Optional) TThe maximum depth to recur if the -Recurse switch is given. A value less than 0 will recur infinitely. The default is -1 (infinite).</param>
        public static void WalkFolderTree(
            ...
            if (verboseAPIAction != null)
                verboseAPIAction("Retrieving child items for folder: " + folder.Id);
